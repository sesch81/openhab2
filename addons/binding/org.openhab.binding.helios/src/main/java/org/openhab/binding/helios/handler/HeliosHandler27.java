...
import org.openhab.binding.helios.ws.soap.SOAPActionHandler;
import org.openhab.binding.helios.ws.soap.SOAPCallStateChanged;
import org.openhab.binding.helios.ws.soap.SOAPCardEntered;
import org.openhab.binding.helios.ws.soap.SOAPCodeEntered;
import org.openhab.binding.helios.ws.soap.SOAPDeviceState;
import org.openhab.binding.helios.ws.soap.SOAPEvent;
import org.openhab.binding.helios.ws.soap.SOAPKeyPressed;
import org.openhab.binding.helios.ws.soap.SOAPObjectFactory;
import org.openhab.binding.helios.ws.soap.SOAPSubscriptionActionHandler;
...
public class HeliosHandler27 extends BaseThingHandler implements NotificationConsumer {
    ...
    public final static String HELIOS_URI = "http://www.2n.cz/2013/event";
    public final static String DIALECT_URI = "http://www.2n.cz/2013/TopicExpression/Multiple";
    public final static String WSN_URI = "http://docs.oasis-open.org/wsn/b-2";

    public final static QName TOPIC_EXPRESSION = new QName(WSN_URI, "TopicExpression");
    public final static QName INITIAL_TERMINATION_TIME = new QName(WSN_URI, "InitialTerminationTime");
    public final static QName MAXIMUM_NUMBER = new QName(HELIOS_URI, "MaximumNumber");
    public final static QName SIMPLE_MESSAGES = new QName(HELIOS_URI, "SimpleMessages");
    public final static QName START_TIME_STAMP = new QName(HELIOS_URI, "StartTimestamp");
    public final static QName START_RECORD_ID = new QName(HELIOS_URI, "StartRecordId");
    ...
    public void initialize() {
        ...
        try {
            ...
            logger.error("An exception occurred while setting up the notification consumer webservice: {}",
                    e1.getMessage());
        ...
        try {
            ...
            logger.error("An exception occurred while setting up the notification webservice client: {}",
                    e1.getMessage());
            updateStatus(ThingStatus.OFFLINE, ThingStatusDetail.COMMUNICATION_ERROR);
            return;
        }
        ...
        try {
            ...
            logger.error("An exception occurred while setting up the subscription manager client: {}", e1.getMessage());
            updateStatus(ThingStatus.OFFLINE, ThingStatusDetail.COMMUNICATION_ERROR);
            return;
        }
        ...
        try {
            ...
            logger.error("An exception occurred while subscribing to the notifications for thing '{}': {}",
    ...
    public void notify(
        ...
        for (Object object : notify.getAny()) {
            try {
                ...
                logger.error("An exception occurred while processing a notification message : {}", e.getMessage());
                e.printStackTrace();
            }
        }
    }
    ...
    public void unsubscribe() {
        if (subscription != null) {
            try {
                ...
                logger.error("An exception occurred while unsubscribing from the subscription : {}", e.getMessage());
            }
        }
    }
    ...
    public void subscribe(W3CEndpointReference epr)
        ...
        if (notificationProducer != null) {
            ...
            // subscribeRequest.getSubscriptionPolicy().getAny()
            // .add(new JAXBElement<Integer>(START_RECORD_ID, Integer.class, 1));
            ...
            if (response != null) {
                ...
                try {
                    ...
                    logger.error("An exception occurred while scheduling a renewal : '{}'", e.getMessage());
                }
    ...
    protected Runnable renewRunnable = new Runnable() {
        ...
        @Override
        public void run() {
            Logger logger = LoggerFactory.getLogger(HeliosHandler27.class);
            ...
            try {
                ...
                logger.error("An exception occurred while renewing the subscription : {}", e.getMessage());
                e.printStackTrace();
